...
<label for="field3"><span>No Telpon <span class="required">*</span></span><input type="text" class="input-field" name="field3" value="" /></label>

<label for="field5"><span>Jurusan</span>
<select name="field5" class="select-field">
<option value="Sistem Informasi">Sistem Informasi</option>
<option value="Informatika">Informatika</option>
</select></label>

<label for="field6"><span>Jenis Kelamin</span>
<select name="field6" class="select-field">
<option value="Laki-Laki">Laki-Laki</option>
<option value="Perempuan">Perempuan</option>
</select></label>

<label for="field7"><span>Agama</span>
